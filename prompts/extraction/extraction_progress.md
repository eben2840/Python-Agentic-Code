...
- Extract the information  as event.
- Extract if the report is high priority, addendum, handover, doctor info or all of them. If nothing is mentioned then analyze the situation to infer it.
